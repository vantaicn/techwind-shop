!(function (t, e) {
    ...
    class l {
        ...
        init() {
            this.addClasses([r.SHUFFLE_ITEM, r.VISIBLE]),
                ...
                this.applyCss(
                    this.isRTL ? l.Css.DIRECTION.rtl : l.Css.DIRECTION.ltr,
                ),
    ...
    function _(t) {
        return (
            !!p[t] &&
            (p[t].element.removeEventListener(f, p[t].listener),
            (p[t] = null),
            !0)
        );
    }
    function y(t, e) {
        ...
        return (
            t.addEventListener(f, s), (p[i] = { element: t, listener: s }), i
        );
    }
    function I(t) {
        return Math.max(...t);
    ...
    class L extends t.exports {
        ...
        _getFilteredSets(t, e) {
            ...
            return (
                t === L.ALL_ITEMS
                    ? (i = e)
                    : e.forEach((e) => {
                          this._doesPassFilter(t, e.element)
                              ? i.push(e)
                              : s.push(e);
                      }),
                { visible: i, hidden: s }
        ...
        _getNextPositions(t) {
            ...
            return t.map((t) =>
                this._getItemPosition(L.getSize(t.element, !0)),
            );
        }
        _getItemPosition(t) {
            return (function (t) {
        ...
        _shrink() {
            ...
            t.forEach((t) => {
                ...
                if (t.isHidden)
                    return t.applyCss(l.Css.HIDDEN.before), void i();
            ...
            if (this.options.useTransforms) {
                const e = this.options.isRTL ? '-' : '',
                    s = this.options.roundTransforms
                        ...
                        : t.point.x,
                    n = this.options.roundTransforms
